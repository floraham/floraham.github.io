---
title: 'Does global warming affect soil carbon respiration?'
...
*Does a soil warming effect cause soil to change its monthly average respiration rates in a different way than an untreated plot naturally changes respiration?*
...
While these research findings have been formalized by the studies' scientists, I would like to better understand the relationship between global warming and soil respiration for myself by applying hypothesis testing and linear regression, using the data from the Barre Woods site to evaluate changes of carbon flux based on differences in soil temperature and soil moisture over time.
...
![](images/Screenshot 2023-12-15 at 12.42.31 PM.png)
...
![](images/Screenshot 2023-12-15 at 1.34.36 PM.png)
...
## Evaluating significant differences in average CO2flux between average treatment and control plots
...
Once again, let's define a single variable categorical regression model with just monthly averages data. We regress Co2 flux on treatment.
...
![](images/Screenshot 2023-12-15 at 2.25.58 PM.png){width="455"}

```{r}
print(summary(model_0))
```

![](images/Screenshot 2023-12-15 at 12.58.52 PM.png){width="432"}
...
![](images/Screenshot 2023-12-15 at 1.14.28 PM.png){width="516"}
