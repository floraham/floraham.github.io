---
title: "Visualizing lobster size differences across MPA and Non-MPA sites"
author:
  - name: Flora Hamilton
...
It may be important to show sample size, because just looking at the data, I am able to see that the CARP site in 2022 has a much bigger range in count than other sites. This may show not only stronger evidence of a change in size, but also count, possibly due to the establishment of MPAs. This visualization might be a bit tricky, due to the number of dimensions and factors of each dimension we're dealing with -- time, 5 different sites, lobster length, potential need to demonstrate sample size, etc. It might also be important to distinguish MPA's from non-MPA's somehow.
