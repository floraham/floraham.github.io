...
Using satellite imagery, roads & house data, and socioeconomic data
...
-   convert the polygon into a simple feature collection using `st_sfc()` and assign a CRS, making sure that the polygon is in the same CRS
...
-   join the income data to the census tract geometries by joining by geometry ID\
